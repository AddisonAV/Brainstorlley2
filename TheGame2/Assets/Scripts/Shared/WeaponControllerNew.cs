...
namespace TheGame.Game
{
    ...
    public class WeaponControllerNew : MonoBehaviour
    {
        ...
        [Tooltip("The projectile prefab")] public ProjectileBaseNew ProjectilePrefab;
        ...
        void Awake()
        {
            ...
            DebugUtility.HandleErrorIfNullGetComponent<AudioSource, WeaponControllerNew>(m_ShootAudioSource, this,
                gameObject);
            ...
            if (UseContinuousShootSound)
            {
                ...
                m_ContinuousShootAudioSource.outputAudioMixerGroup =
                    AudioUtilityNew.GetAudioGroup(AudioUtilityNew.AudioGroups.WeaponShoot);
        ...
        void PlaySFX(AudioClip sfx) => AudioUtilityNew.CreateSFX(sfx, transform.position, AudioUtilityNew.AudioGroups.WeaponShoot, 0.0f);
        ...
        void HandleShoot()
        {
            ...
            for (int i = 0; i < bulletsPerShotFinal; i++)
            {
                ...
                ProjectileBaseNew newProjectile = Instantiate(ProjectilePrefab, WeaponMuzzle.position,
