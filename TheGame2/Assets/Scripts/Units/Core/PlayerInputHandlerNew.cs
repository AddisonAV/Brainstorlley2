...
{
    public class PlayerInputHandlerNew : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            DebugUtility.HandleErrorIfNullGetComponent<PlayerCharacterControllerNew, PlayerInputHandlerNew>(
                m_PlayerCharacterController, this, gameObject);
            m_GameFlowManager = FindObjectOfType<GameFlowManager>();
            DebugUtility.HandleErrorIfNullFindObject<GameFlowManager, PlayerInputHandlerNew>(m_GameFlowManager, this);
