...
namespace TheGame.Game
{
    ...
    public class ActorNew : MonoBehaviour
    {
        ...
        ActorsManagerNew m_ActorsManager;

        void Start()
        {
            m_ActorsManager = GameObject.FindObjectOfType<ActorsManagerNew>();
            DebugUtility.HandleErrorIfNullFindObject<ActorsManagerNew, ActorNew>(m_ActorsManager, this);
