...
namespace TheGame.Gameplay
{
    ...
    public class JetpackNew : MonoBehaviour
    {
        ...
        PlayerCharacterControllerNew m_PlayerCharacterController;
        ...
        void Start()
        {
            ...
            m_PlayerCharacterController = GetComponent<PlayerCharacterControllerNew>();
            DebugUtility.HandleErrorIfNullGetComponent<PlayerCharacterControllerNew, JetpackNew>(m_PlayerCharacterController,
                this, gameObject);

            m_InputHandler = GetComponent<PlayerInputHandlerNew>();
            DebugUtility.HandleErrorIfNullGetComponent<PlayerInputHandlerNew, JetpackNew>(m_InputHandler, this, gameObject);
