...
{
    public class AudioUtilityNew
    {
        static AudioManagerNew s_AudioManager;
            ...
            float rolloffDistanceMin = 1f)
        {
            ...
            TimedSelfDestructNew timedSelfDestruct = impactSfxInstance.AddComponent<TimedSelfDestructNew>();
        ...
        public static AudioMixerGroup GetAudioGroup(AudioGroups group)
        {
            if (s_AudioManager == null)
                s_AudioManager = GameObject.FindObjectOfType<AudioManagerNew>();
